...
echo -e "${G1}installing aws s3 (for downloading datasets)${G2}"
...
echo -e "${G1}downloading covid data...${G2}"
...
echo -e "${G1}downloading human data...${G2}"
...
echo -e "${G1}setting up virtual environment...${G2}"
