...
HD_PWD='C:/verilog/verilog_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_norm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_norm.tcl
