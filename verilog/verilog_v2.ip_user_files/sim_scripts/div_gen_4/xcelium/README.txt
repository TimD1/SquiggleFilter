...
#
# Generated by export_simulation on Wed Nov 11 11:09:46 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './div_gen_4.sh' script.

./div_gen_4.sh -reset_run
...
./div_gen_4.sh -noclean_files

For more information on the script, please type './div_gen_4.sh -help'.
