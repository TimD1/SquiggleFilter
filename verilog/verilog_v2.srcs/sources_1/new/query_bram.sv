...
`endif  
`timescale 1ns / 1ns
module bram_wA_rB #(parameter WIDTH=`DATA_WIDTH, parameter ADDR_WIDTH=`QUERY_SIZE_BITS, parameter DEPTH=`QUERY_LEN, parameter PIPELINE=0, parameter MEMORY_TYPE = "auto") 
(
   input clk,
   input wea,
   input ena,
